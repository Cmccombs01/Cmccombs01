...
* **[DM Co-Pilot](Link to repo): An open-source, AI-powered JSON data pipeline and VTT export tool built with Python, Streamlit, Groq, and Firestore. Scaled to handle 450+ concurrent users and 1,100+ interactions with sub-2-second latency.
